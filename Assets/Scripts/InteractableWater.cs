...
public class InteractableWaterEditor : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        corners[3] = center + new Vector3(water.Width / 2, water.Height / 2, 0); //Bottom left
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ChangeDimensions(ref water.Width, ref water.Height, corners[0].x - newBottomLeft.x, corners[3].y - newBottomRight.y);
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ChangeDimensions(ref water.Width, ref water.Height, newBottomLeft.x - corners[2].x, newTopRight.y - corners[1].y);
